...
- The final signed archive completed successfully at `ios/build/Xochi-0.1.0-3.xcarchive`; `testflight-archive-3-final.log` ends with ARCHIVE SUCCEEDED. Build 3 was not uploaded and is superseded by uploaded build 4.
