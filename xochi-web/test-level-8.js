...
async function runTest() {
  ...
  try {
      ...
      return new Promise((resolve) => {
        ...
        const checkInterval = setInterval(() => {
          ...
          try {
            ...
            console.log('[Test Code] Game info:', gameInfo);
    ...
    const levelState = await page.evaluate(() => {
      return new Promise((resolve) => {
        try {
          ...
          console.log('[Test Code] Level state:', state);
    ...
    console.log('\n10. Observing music playback (5 seconds)...');
    await page.waitForTimeout(5000);

    // Final check
    console.log('\n11. Final audio check...');
